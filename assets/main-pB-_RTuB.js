import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */const s=document.getElementById("menu-button"),r=document.getElementById("nav-mobile_menu"),u=document.getElementById("nav-mobile"),g=document.querySelectorAll("#nav-mobile_menu a"),d=document.querySelector("body"),i=document.getElementById("overlay");console.log(s);s&&r&&u&&g&&d&&i&&(console.log(" [1] menu button exists"),s.addEventListener("click",()=>{console.log("[1] clicked button ",s),s.classList.contains("active")?(setTimeout(()=>{m(s,[r,u])},200),d.style.overflow="auto",i.style.display="none",i.style.opacity="0"):(m(s,[r,u]),d.style.overflow="hidden",i.style.display="block",i.style.opacity="1"),g.forEach((n,t)=>{n.classList.contains("active")?e(n):setTimeout(()=>{n.classList.add("active")},200)});function e(n,t){n.classList.toggle("active")}console.log("[1] button has class",s.classList)}));const p=document.getElementById("countdown");if(p){const e=L();w(e,p)}function w(e,n){const t=`
        <span>
            <span>:</span>
        </span>
    `;n.innerHTML=`
